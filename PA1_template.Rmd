...
```
These results for mean and median are not surprising as the median of the uncorrected set is `r rawsteps_median`, so replacing NAs with this unsurprisingly a) reduces the mean and b) has no impact on the median.
